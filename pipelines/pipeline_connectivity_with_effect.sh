...
#Get components
perl ~/find_components.pl ~/datasets/connectivity_with_effect/paths_activation_components.txt ~/datasets/connectivity_with_effect/activation_components.txt
perl ~/find_components.pl ~/datasets/connectivity_with_effect/paths_inhibition_components.txt ~/datasets/connectivity_with_effect/inhibition_components.txt 

#Connectivity calculation
perl ~/connectivity_calculator_weffect.pl ~/datasets/connectivity_with_effect/ ~/datasets/connectivity_with_effect/connectivity_summary.txt
