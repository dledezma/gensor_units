#################################################################################
###### 19-10-15                                                            ######
###### Add secondary reactions                                             ######
###### Finds secondary reactions at most N reactions away. Copies          ######
######  gu_assembly_vX.pl output and includes them.                        ######
###### Arguments:                                                          ############ [0] - gu_assembly_vX.pl output directory                            ######
###### [1] - Output directory                                              ######
...
######                 other reactions.                                    ######
###### Required files:                                                     ######
######  - rxn_rpd_links file (from gene_reactions_flatfiles.pl)            ######
###### Notes:                                                              ######
